...
defineMessages({
  ...
  world: {
    \\"id\\": \\"lib.__fixtures__.world\\",
    defaultMessage: 'world'
  },
  headerTitle: {
    \\"id\\": \\"lib.__fixtures__.headerTitle\\",
    defaultMessage: 'Welcome to dashboard {name}!',
    description: 'Message to greet the user.'
  }
});
...
export default defineMessages({
  hello: {
    \\"id\\": \\"lib.__fixtures__.helloworld\\",
...
export default defineMessages({
  hello: {
    \\"id\\": \\"lib.__fixtures__.messages.hello\\",
    \\"defaultMessage\\": 'hello'
  }
});
"
...
export default defineMessages({
  hello: {
    \\"id\\": \\"lib.__fixtures__.default.hello\\",
    \\"defaultMessage\\": 'hello'
  }
});
"
...
export const extra = defineMessages({
  hello: {
    \\"id\\": \\"lib.__fixtures__.extra.hello\\",
    \\"defaultMessage\\": 'hello world extra'
  }
});
export default defineMessages({
