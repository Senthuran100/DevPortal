...
import { FormattedMessage } from 'react-intl';
<FormattedMessage id=\\"lib.__fixtures__.613153351\\" defaultMessage=\\"hello\\" />;
"
`;

exports[`default import all supported components: import all supported components 1`] = `
"
...
import { FormattedHTMLMessage, FormattedMessage } from 'react-intl';
<FormattedHTMLMessage id=\\"lib.__fixtures__.205247277\\" defaultMessage=\\"<span>hello</span>\\" />;
<FormattedMessage id=\\"lib.__fixtures__.613153351\\" defaultMessage=\\"hello\\" />;
"
`;
...
import { FormattedMessage } from 'react-intl';
<FormattedMessage id=\\"lib.__fixtures__.613153351\\" defaultMessage=\\"hello\\" />;
<FormattedMessage id=\\"lib.__fixtures__.1418522856\\" defaultMessage=\\"another\\" />;
"
`;
...
import { FormattedMessage as T } from 'react-intl';
<T id=\\"lib.__fixtures__.613153351\\" defaultMessage=\\"hello\\" />;
"
`;
...
import { FormattedMessage } from 'react-intl';
<FormattedMessage id=\\"lib.__fixtures__.3540954520\\" defaultMessage={\`hello world 2\`} />;
"
`;
...
import { FormattedMessage } from 'react-intl';
const message = \\"variable message\\";
<FormattedMessage id=\\"lib.__fixtures__.3082794952\\" defaultMessage={message} />;
"
`;
...
import { FormattedMessage } from 'react-intl';
<FormattedMessage id=\\"lib.__fixtures__.messages.613153351\\" defaultMessage=\\"hello\\" />;
"
`;
...
import { FormattedMessage } from 'react-intl';
<FormattedMessage id=\\"lib.613153351\\" defaultMessage=\\"hello\\" />;
"
`;
